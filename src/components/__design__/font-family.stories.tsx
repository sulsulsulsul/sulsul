...
export const FontFamily: StoryObj = {
  render: () => (
    <div className="flex h-full flex-row flex-wrap items-center justify-start gap-1">
      <div>
        <p className="text-2xs font-normal">Text 2XS/Normal</p>
        <p className="text-2xs font-medium">Text 2XS/Medium</p>
        <p className="text-2xs font-semibold">Text 2XS/SemiBold</p>
        <p className="text-2xs font-bold">Text 2XS/Bold</p>
      </div>
      <div>
        <p className="text-xs font-normal">Text XS/Normal</p>
      ...
      <div>
        <p className="text-sm font-normal">Text SM/Normal</p>
      ...
      <div>
        ...
        <p className="text-base font-semibold">Text Base/SemiBold</p>
        <p className="text-base font-bold">Text Base/Bold</p>
      </div>
      <div>
        <p className="text-lg font-normal">Text LG/Normal</p>
      ...
      <div>
        <p className="text-2xl font-normal">Text 2XL/Normal</p>
      ...
      <div>
        <p className="text-3xl font-normal">Text 3XL/Normal</p>
      ...
      <div>
        <p className="text-4xl font-normal">Text 4XL/Normal</p>
      ...
      <div>
        <p className="text-5xl font-normal">Text 5XL/Normal</p>
      ...
      <div>
        <p className="text-6xl font-normal">Text 6XL/Normal</p>
