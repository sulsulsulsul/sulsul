  ...
  return (
    <>
      ...
      <main className="fixed left-0 top-0 z-[60] flex h-screen w-screen items-center justify-center mobile:flex-col">
        <div className="fixed top-0 z-[999] flex h-14 w-full items-center justify-center border border-gray-200 tablet:hidden desktop:hidden">
          <Image
        ...
        <div className="absolute h-[calc(100vh-100px)] w-[688px] overflow-y-scroll rounded-md bg-white px-[100px] py-[80px] mobile:h-full mobile:w-screen mobile:rounded-none mobile:px-0">
          <Image
