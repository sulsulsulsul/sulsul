...
const PracticeQuestions = ({
  ...
  return (
    <div className={cn(className, 'w-[586px]')}>
      ...
      />
      {isDesktop ? (
        <div className=" flex h-[420px] flex-col gap-3 overflow-x-visible overflow-y-scroll pb-4 pr-3 pt-6 scrollbar-hide mobile:mt-4 ">
